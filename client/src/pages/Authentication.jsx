  ...
  const onSubmitForm = async( event ) => {
    ...
    try {
      ...
      const USER = {
        ...
        department: {
          id_department: user.departamento.id_departamento,
          name_department: user.departamento.nombre_departamento
        }
      }
  ...
  return (
    <main className="h-screen w-screen flex flex-col lg:flex-row justify-center items-center">
      <section className="h-1/4 w-full flex justify-center items-center">
        <img className="w-3/5 md:w-2/5" src={ logoOpc } alt="Logo de OPC Ingeniería y Construcción" />
      </section>
